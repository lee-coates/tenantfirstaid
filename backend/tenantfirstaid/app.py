...
app.add_url_rule("/api/prompt", endpoint="prompt_get",
                 view_func=get_prompt,  methods=["GET"])
app.add_url_rule("/api/prompt", endpoint="prompt_post",
                 view_func=set_prompt, methods=["POST"])
